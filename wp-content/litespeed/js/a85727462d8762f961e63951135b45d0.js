...
rpi.Time = {
    ...
    getFormatTime: function(a, c, f) {
        ...
        return c.replace(/(SS|ss|mm|HH|hh|DD|dd|MM|yyyy|yy|ago|12)/g, function(m, l) {
            m = e[l];
            return 10 > m ? "0" + m : m
        })
    },
    ...
    declineMsg: function(a, c, f, h, e) {
        var m = a % 10;
        return 1 == m && (1 == a || 20 < a) ? c : 1 < m && 5 > m && (20 < a || 10 > a) ? f : a ? h : e
    }
};
rpi.Time.Messages = {
    ru: {
        ...
        hour: "\u0447\u0430\u0441 \u043d\u0430\u0437\u0430\u0434",
        hours: function(a) {
            return rpi.Time.declineNum(Math.round(a), "\u0447\u0430\u0441 \u043d\u0430\u0437\u0430\u0434", "\u0447\u0430\u0441\u0430 \u043d\u0430\u0437\u0430\u0434", "\u0447\u0430\u0441\u043e\u0432 \u043d\u0430\u0437\u0430\u0434")
        },
        day: "\u0434\u0435\u043d\u044c \u043d\u0430\u0437\u0430\u0434",
        days: function(a) {
        ...
        year: "\u0433\u043e\u0434 \u043d\u0430\u0437\u0430\u0434",
        years: function(a) {
            return rpi.Time.declineNum(Math.round(a), "\u0433\u043e\u0434 \u043d\u0430\u0437\u0430\u0434", "\u0433\u043e\u0434\u0430 \u043d\u0430\u0437\u0430\u0434", "\u043b\u0435\u0442 \u043d\u0430\u0437\u0430\u0434")
        }
    },
    en: {
        second: "just now",
    ...
    uk: {
        ...
        hour: "\u0433\u043e\u0434\u0438\u043d\u0443 \u0442\u043e\u043c\u0443",
        hours: function(a) {
            return rpi.Time.declineNum(Math.round(a), "\u0433\u043e\u0434\u0438\u043d\u0443 \u0442\u043e\u043c\u0443", "\u0433\u043e\u0434\u0438\u043d\u0438 \u0442\u043e\u043c\u0443", "\u0433\u043e\u0434\u0438\u043d \u0442\u043e\u043c\u0443")
        },
        day: "\u0434\u0435\u043d\u044c \u0442\u043e\u043c\u0443",
        days: function(a) {
        ...
        month: "\u043c\u0456\u0441\u044f\u0446\u044c \u0442\u043e\u043c\u0443",
        months: function(a) {
            return rpi.Time.declineNum(Math.floor(a / 30), "\u043c\u0456\u0441\u044f\u0446\u044c \u0442\u043e\u043c\u0443", "\u043c\u0456\u0441\u044f\u0446\u0456 \u0442\u043e\u043c\u0443", "\u043c\u0456\u0441\u044f\u0446\u0456\u0432 \u0442\u043e\u043c\u0443")
        },
        year: "\u0440\u0456\u043a \u0442\u043e\u043c\u0443",
        years: function(a) {
    ...
    ro: {
        ...
        minutes: function(a) {
            return rpi.Time.declineNum(Math.round(a), "o minuta in urma", "minute in urma", "de minute in urma")
        },
        hour: "acum o ora",
        hours: function(a) {
        ...
        year: "un an in urma",
        years: function(a) {
            return rpi.Time.declineNum(Math.round(a), "un an in urma", "ani in urma", "de ani in urma")
        }
    },
    lv: {
        ...
        day: "pirms dienas",
        days: function(a) {
            return rpi.Time.declineNum(Math.round(a), "pirms dienas", "pirms dien\u0101m", "pirms dien\u0101m")
        },
        month: "pirms m\u0113ne\u0161a",
        months: function(a) {
    ...
    kk: {
        ...
        minutes: function(a) {
            return rpi.Time.declineNum(Math.round(a), "\u043c\u0438\u043d\u0443\u0442 \u0431\u04b1\u0440\u044b\u043d", "\u043c\u0438\u043d\u0443\u0442 \u0431\u04b1\u0440\u044b\u043d", "\u043c\u0438\u043d\u0443\u0442 \u0431\u04b1\u0440\u044b\u043d")
        },
    ...
    ka: {
        ...
        minute: "\u10ec\u10e3\u10d7\u10d8\u10e1 \u10ec\u10d8\u10dc",
        minutes: function(a) {
            return rpi.Time.declineNum(Math.round(a), "\u10ec\u10e3\u10d7\u10d8\u10e1 \u10ec\u10d8\u10dc", "\u10ec\u10e3\u10d7\u10d8\u10e1 \u10ec\u10d8\u10dc", "\u10ec\u10e3\u10d7\u10d8\u10e1 \u10ec\u10d8\u10dc")
        },
        hour: "\u10e1\u10d0\u10d0\u10d7\u10d8\u10e1 \u10ec\u10d8\u10dc",
        hours: function(a) {
        ...
        day: "\u10d3\u10e6\u10d8\u10e1 \u10ec\u10d8\u10dc",
        days: function(a) {
            return rpi.Time.declineNum(Math.round(a), "\u10d3\u10e6\u10d8\u10e1 \u10ec\u10d8\u10dc", "\u10d3\u10e6\u10d8\u10e1 \u10ec\u10d8\u10dc", "\u10d3\u10e6\u10d8\u10e1 \u10ec\u10d8\u10dc")
        },
        month: "\u10d7\u10d5\u10d8\u10e1 \u10ec\u10d8\u10dc",
        months: function(a) {
        ...
        year: "\u10ec\u10da\u10d8\u10e1 \u10ec\u10d8\u10dc",
        years: function(a) {
            return rpi.Time.declineNum(Math.round(a), "\u10ec\u10da\u10d8\u10e1 \u10ec\u10d8\u10dc", "\u10ec\u10da\u10d8\u10e1 \u10ec\u10d8\u10dc", "\u10ec\u10da\u10d8\u10e1 \u10ec\u10d8\u10dc")
        }
    },
    hy: {
        ...
        year: "\u0574\u0565\u056f \u057f\u0561\u0580\u056b \u0561\u057c\u0561\u057b",
        years: function(a) {
            return rpi.Time.declineNum(Math.round(a), "\u057f\u0561\u0580\u056b \u0561\u057c\u0561\u057b", "\u057f\u0561\u0580\u056b \u0561\u057c\u0561\u057b", "\u057f\u0561\u0580\u056b \u0561\u057c\u0561\u057b")
        }
    },
    fr: {
    ...
    be: {
        ...
        minute: "\u0445\u0432\u0456\u043b\u0456\u043d\u0443 \u0442\u0430\u043c\u0443",
        minutes: function(a) {
            return rpi.Time.declineNum(Math.round(a), "\u0445\u0432\u0456\u043b\u0456\u043d\u0430 \u0442\u0430\u043c\u0443", "\u0445\u0432\u0456\u043b\u0456\u043d\u044b \u0442\u0430\u043c\u0443", "\u0445\u0432\u0456\u043b\u0456\u043d \u0442\u0430\u043c\u0443")
        },
        hour: "\u0433\u0430\u0434\u0437\u0456\u043d\u0443 \u0442\u0430\u043c\u0443",
        hours: function(a) {
        ...
        day: "\u0434\u0437\u0435\u043d\u044c \u0442\u0430\u043c\u0443",
        days: function(a) {
            return rpi.Time.declineNum(Math.round(a), "\u0434\u0437\u0435\u043d\u044c \u0442\u0430\u043c\u0443", "\u0434\u043d\u0456 \u0442\u0430\u043c\u0443", "\u0434\u0437\u0451\u043d \u0442\u0430\u043c\u0443")
        },
        month: "\u043c\u0435\u0441\u044f\u0446 \u0442\u0430\u043c\u0443",
        months: function(a) {
    ...
    it: {
        ...
        day: "un giorno fa",
        days: function(a) {
            return rpi.Time.declineNum(Math.round(a), "un giorno fa", "giorni fa", "giorni fa")
        },
        month: "un mese fa",
        months: function(a) {
...
rpi.Utils = {
    ...
    anchor: function(a, c, f, h, e) {
        ...
        return '<a href="' + a + '"' + (h ? ' class="' + h + '"' : "") + (f.open_link ? ' target="_blank"' : "") + (m.length ? ' rel="' + m.join(" ") + '"' : "") + (e ? ' aria-label="' + e + '"' : "") + ">" + c + "</a>"
    },
    rm: function(a) {
...
rpi.Column = function(a, c, f) {
    const h = a.getAttribute("data-id"),
        ...
        m = new RegExp('$|(\\[data-id="' + h + '"\\]\\s+.' + f.card + "\\s*{\\s*--col:\\s*\\d+\\s*!important\\s*;?(\\s*--gap:\\s*\\d+\\s*!important;?)?})"),
        l = a.getElementsByClassName(f.cnt)[0];
    var n = null;
    return n = {
        init: function(k, q) {
            rpi.Utils.isVisible(l) ? (k && k(), n.resize(), window.addEventListener("resize", n.resize), q && q(), rpi.Instances = rpi.Instances || [], rpi.Instances.push(n)) : setTimeout(n.init, 300)
        },
        resize: function() {
            let k = n.getSize();
        ...
        getSize: function() {
            let k = l.offsetWidth;
            return 510 > k ? "xs" : 750 > k ? "x" : 1100 > k ? "s" : 1450 > k ? "m" : 1800 > k ? "l" : "xl"
        },
        setCol: function(k) {
            let q = this.getStyle();
            q.innerHTML = q.innerHTML.replace(m, '[data-id="' + h + '"] .' + f.card + "{--col:" + k + "!important;--gap:" + (k - 1) + "!important}")
        },
        getCol: function() {
        ...
        getStyle: function() {
            ...
            k || (k = document.createElement("style"), k.id = "rpi-style", document.head.appendChild(k));
            return k
        },
...
rpi.Common = function(a, c, f) {
    ...
    return h = {
        init: function() {
            ...
            for (var l = 0; l < e.length; l++) e[l].innerHTML = h.time(e[l].getAttribute("data-time"));
            for (e = 0; e < m.length; e++)(l = m[e]) && l.innerHTML && (l.innerHTML = h.trimtext(l.innerHTML), l = l.getElementsByClassName(f.readmore)[0]) && (l.onclick = h.opentext)
        },
        initOnce: function(e) {
            var m = e.getElementsByClassName(f.time)[0];
            e = e.getElementsByClassName(f.text)[0];
            m && (m.innerHTML = h.time(m.getAttribute("data-time")));
            e && e.innerHTML && (e.innerHTML = h.trimtext(e.innerHTML), m = e.getElementsByClassName(f.readmore)[0]) && (m.onclick = h.opentext)
        },
        time: function(e) {
            return c.time_format ? e : rpi.Time.getTimeAgo(1E3 * parseInt(e), rpi.Utils.lang())
        },
        trimtext: function(e, m) {
            ...
            if (e && l && e.length > l) {
                ...
                if (1 > n || l - n > l / 2) n = l;
                var k = l = "";
                0 < n && (l = e.substring(0, n - 1), k = e.substring(n - 1, e.length));
                return l + (!m && k ? '<span class="rpi-s">... </span><input type="hidden" value="' + k + '"></input><span class="' + f.readmore + '">' + rpi.Utils.__("read more", c.trans) + "</span>" : "")
            }
            return e
        },
        opentext: function() {
...
rpi.Slider = function(a, c, f, h) {
    ...
    return d = {
        init: function(b, g) {
            rpi.Utils.isVisible(e) ? (b && b(), d.resize(), d.actions(), r.length && d.swipeAutoStart(), g && g(), rpi.Instances = rpi.Instances || [], rpi.Instances.push(d)) : setTimeout(d.init, 300)
        },
        resize: function(b) {
            let g = h.column.resize(),
                p = h.column.getCol();
            b && l.scrollLeft != b * d.reviewWidth() && l.scrollTo(r[b].offsetLeft, 0);
        ...
        actions: function() {
            ...
            l && (l.addEventListener("scroll", d.scrollListener, !1), c.wheelscroll && m.addEventListener("wheel", d.wheelListener, !1));
        ...
        wheelListener: function(b) {
            var g = b.target;
            if ((g = -1 < g.className.indexOf(f.text) ? g : -1 < g.parentNode.className.indexOf(f.text) ? g.parentNode : null) && g.scrollHeight > g.clientHeight) return !0;
            b.preventDefault();
            B++;
            clearTimeout(z);
        ...
        loadNextReviews: function(b) {
            b = b ? d.reviewsIdx() + parseInt(b) : d.hasDots() ? (b = k.getElementsByClassName("active")[0]) ? parseInt(b.getAttribute("data-index")) * d.swipePerDot() : d.reviewsIdx() : d.reviewsIdx();
            b = d.getAjaxSize(b);
        ...
        dotScroll: function(b, g) {
            ...
            g ? k.scrollTo(b.offsetLeft - t * p, 0) : k.scrollTo({
        ...
        scroll: function(b) {
            ...
            g = 0 > g ? 0 : g >= r.length ? r.length - 1 : g; - 1 < g && g < r.length && (l.scrollTo({
                left: r[g].offsetLeft,
                behavior: "smooth"
...
function grw_init(a, c) {
    ...
    if ("true" != a.getAttribute("data-exec")) {
        ...
        !a.getElementsByClassName("grw-review")[0] || "slider" != c && "grid" != c || (c = a.getElementsByClassName("grw-row")[0], c = JSON.parse(c.getAttribute("data-options")), f = rpi.Column(a, c, {
            cnt: "grw-row",
            col: "grw-row",
            card: "grw-review"
        }), rpi.Slider(a, c, {
